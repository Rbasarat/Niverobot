...
class DateParser(object):
    ...
    def ParseDate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dateParser.DateParser/ParseDate',
            dateparser__pb2.ParseDateRequest.SerializeToString,
            dateparser__pb2.ParseDateReply.FromString,
